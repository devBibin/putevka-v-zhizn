...
urlpatterns = [
    ...
    path("video/upload-init/", views.my_video_upload_init, name="my_video_upload_init"),
    path("video/upload-finalize/", views.my_video_upload_finalize, name="my_video_upload_finalize"),
