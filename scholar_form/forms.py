...
class PersonalForm(forms.ModelForm):
    ...
    vk = forms.CharField(
        ...
        widget=forms.TextInput(attrs={
            "caption": "Ссылка должна быть в формате https://vk.com/id000000000"
        })
    )
        ...
        widgets = {
            ...
            'target_universities': forms.Textarea(
                attrs={'placeholder': '1. МГУ, Москва\n2. СПбПУ, Санкт-Петербург\n3. КубГУ, Краснодар…',
                       "caption": 'Мы не требуем от тебя окончательного решения уже сейчас. Укажи те вузы, в которых ты хотел(-а) бы учиться.'}),
            'specializations': forms.Textarea(attrs={'placeholder': 'Прикладная математика, инженерия',
                                                     'caption': 'Мы не требуем от тебя окончательного решения уже сейчас. Укажи в заявке те направления, '
