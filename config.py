...
GOOGLE_DRIVE_INTERVIEW_FOLDER_ID = get_variable('GOOGLE_DRIVE_INTERVIEW_FOLDER_ID')
GOOGLE_SHEETS_TEMPLATE_FILE_ID = get_variable('GOOGLE_SHEETS_TEMPLATE_FILE_ID')
