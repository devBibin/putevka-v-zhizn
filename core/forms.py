...
class MotivationLetterForm(forms.ModelForm):
    def clean_letter_text(self):
        ...
        if self.instance.pk:
            ...
            if original_letter.admin_rating and new_letter_text != original_letter.letter_text:
    ...
    def __init__(self, *args, **kwargs):
        ...
        ta.attrs.update({
            ...
            "rows": 15,
            "cols": 80,
            "placeholder": "Начните вводить текст мотивационного письма здесь...",
            "maxlength": str(maxlen),
            "data-maxlen": str(maxlen),
            "hx-post": reverse("motivation_letter_autosave"),
            "hx-trigger": "input changed delay:800ms",
            "hx-include": "this",
            "hx-target": "#autosaveStatus",
            "hx-swap": "innerHTML",
        })
